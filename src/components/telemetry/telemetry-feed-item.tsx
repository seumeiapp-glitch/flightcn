      ...
      {isExpanded && (
        <div className="border-t bg-muted/30 px-4 py-3">
          ...
          <div className="mt-4 flex flex-wrap gap-2 border-t pt-3">
            <button
              type="button"
              className="flex items-center gap-1.5 rounded-md bg-background px-2.5 py-1.5 text-xs font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
            >
